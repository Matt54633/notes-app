...
const note_buttons_container = document.getElementById("note-buttons-container");
...
note_title.innerText = current_note_data[0];
...
edit_cancel_button.addEventListener("click", function () {
    ...
    note_buttons_container.classList.remove("hidden");
    note_content.classList.remove("hidden");
    note_title.classList.remove("hidden");
});
...
function edit_note() {
    ...
    note_buttons_container.classList.add("hidden");
    note_content.classList.add("hidden");
    note_title.classList.add("hidden");
